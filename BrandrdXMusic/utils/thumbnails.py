...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("BrandrdXMusic/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("BrandrdXMusic/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("BrandrdXMusic/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("BrandrdXMusic/assets/assets/play_icons.png")
