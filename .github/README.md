...
- Get your [Necessary Variables](https://github.com/WangLinXMusic/BrandrdXMusic/blob/master/sample.env)
---
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/WangLinXMusic/BrandrdXMusic && cd BrandrdXMusic
   ```
